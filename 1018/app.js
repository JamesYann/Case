...
var schedule_move = require('./routes/schedule_move');
var collection = require('./routes/collection');
var schedule_deleteprocess = require('./routes/schedule_deleteprocess');
//------------------------------------------------------------
...
app.use('/schedule/move', schedule_move);
app.use('/schedule/deleteprocess', schedule_deleteprocess);
